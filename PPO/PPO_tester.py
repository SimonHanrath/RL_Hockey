"""
Script for testing the PPO_agent against the given strong bot.
You can also select a different PPO version as enemy by using the enemy_checkpoint_path argument
and setting use_default_enemy to 0.
"""
import sys
import os
...
def test_policy(checkpoint_path, enemy_checkpoint_path, num_episodes, visualize, action_type,max_timesteps=300):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--checkpoint_path', type=str, default="PPO/checkpoints/gamma_0.96/best_PPO_hockey-eps0.2.pth")
    parser.add_argument('--enemy_checkpoint_path', type=str, default="PPO/checkpoints/gamma_0.96/best_PPO_hockey-eps0.2.pth")
    ...
    test_policy(checkpoint_path, enemy_checkpoint_path, num_episodes, visualize, action_type, use_default_enemy)
